    ...
    if (newPageName) {
        ...
        if (fs.existsSync(path.normalize(templateDefinitionFile))) {
            ...
            createFromPrototype.createFromPrototype("/page/definition.yaml", templateDefinitionFile, {
                "__name__": newPageName,
                "__templateScript__": templateScriptFile.replace(packageJson.config.outputPath, ""),
        ...
        if (!fs.existsSync(path.normalize(templateScriptFile))) {
            createFromPrototype.createFromPrototype("/page/template.ftl", templateScriptFile, {
                "__name__": newPageName,
                "__lightDevModuleFolder__": "/" + packageJson.lightModuleName
            });
        } else {
        ...
        console.log("template name is missing, try again e.g. 'add-page myHome'");
    }
